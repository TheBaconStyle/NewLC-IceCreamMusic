          ...
          onSubmit={handleSubmit(
            async (data) => {
              ...
              for (let track of tracks) {
                ...
                !!track.ringtone && trackFiles.set("ringtone", track.ringtone);
                !!track.text_sync &&
            ...
            <div className={style.wrap}>
              <div>
                ...
                <MyText className={classNames(style.desc, style.mb20)}>
                  Укажите код, он необходим для точности в идентификации релиза
                  на площадках и отчетности, если у вас нет UPC, код будет
          ...
          <>
            <div className={style.wrap}>
              <div>
                ...
                <MyText className={classNames(style.desc, style.mb20)}>
                  Укажите наименование лейбла, данная информация будет
                  отображена на площадках.
                </MyText>
                <MyText className={classNames(style.desc, style.mb20)}>
                  Стоимость изменения лейбла: без подписки: {labelCost.none}р, с
                  подпиской уровня &quot;Стандарт&quot;: {labelCost.standard}р,
                  с подпиской уровня &quot;Профессионал&quot;:{" "}
